...
output "vpc_arn" {
  ...
  value       = var.enabled ? aws_vpc.main[0].arn : null
}

output "vpc_cidr_block" {
  description = "The CIDR block of the VPC"
  value       = var.enabled ? aws_vpc.main[0].cidr_block : null
}

output "vpc_ipv6_cidr_block" {
  description = "The IPv6 CIDR block of the VPC"
  value       = var.enabled && var.ipv6_enabled ? aws_vpc.main[0].ipv6_cidr_block : null
}

output "default_security_group_id" {
  description = "The ID of the security group created by default on VPC creation"
  value       = var.enabled ? aws_vpc.main[0].default_security_group_id : null
}

output "default_network_acl_id" {
  description = "The ID of the default network ACL"
  value       = var.enabled ? aws_vpc.main[0].default_network_acl_id : null
}

output "managed_default_network_acl_id" {
  description = "The ID of the managed default network ACL"
  value       = var.enabled ? aws_default_network_acl.default[0].id : null
}

output "default_route_table_id" {
  description = "The ID of the default route table"
  value       = var.enabled ? aws_default_route_table.default[0].id : null
}
...
output "vpc_block_public_access_options_internet_gateway_block_mode" {
  ...
  value       = var.enabled && var.block_public_access_enabled ? aws_vpc_block_public_access_options.main[0].internet_gateway_block_mode : null
}

output "vpc_instance_tenancy" {
  description = "Tenancy of instances spin up within VPC"
  value       = var.enabled ? aws_vpc.main[0].instance_tenancy : null
}

output "vpc_dns_support_enabled" {
  description = "Whether or not the VPC has DNS support"
  value       = var.enabled ? aws_vpc.main[0].enable_dns_support : null
}

output "vpc_dns_hostnames_enabled" {
  description = "Whether or not the VPC has DNS hostname support"
  value       = var.enabled ? aws_vpc.main[0].enable_dns_hostnames : null
}
...
output "igw_id" {
  ...
  value       = var.enabled && var.igw_enabled ? aws_internet_gateway.main[0].id : null
}

output "igw_arn" {
  description = "The ARN of the Internet Gateway"
  value       = var.enabled && var.igw_enabled ? aws_internet_gateway.main[0].arn : null
}

output "eigw_id" {
  description = "The ID of the Egress-Only Internet Gateway"
  value       = var.enabled && var.ipv6_enabled ? aws_egress_only_internet_gateway.main[0].id : null
}
...
output "public_subnet_arns" {
  ...
  value       = var.enabled ? aws_subnet.public[*].arn : []
}

output "public_subnets_cidr_blocks" {
  description = "List of cidr_blocks of public subnets"
  value       = var.enabled ? aws_subnet.public[*].cidr_block : []
}

output "public_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 CIDR blocks assigned to the public subnets"
  value       = var.enabled ? aws_subnet.public[*].ipv6_cidr_block : []
}
...
output "private_subnet_arns" {
  ...
  value       = var.enabled ? aws_subnet.private[*].arn : []
}

output "private_subnets_cidr_blocks" {
  description = "List of cidr_blocks of private subnets"
  value       = var.enabled ? aws_subnet.private[*].cidr_block : []
}

output "private_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 CIDR blocks assigned to the private subnets"
  value       = var.enabled ? aws_subnet.private[*].ipv6_cidr_block : []
}
...
output "database_subnets" {
  ...
  value       = var.enabled ? aws_subnet.database[*].id : []
}

output "database_subnet_arns" {
  description = "List of ARNs of database subnets"
  value       = var.enabled ? aws_subnet.database[*].arn : []
}

output "database_subnets_cidr_blocks" {
  description = "List of cidr_blocks of database subnets"
  value       = var.enabled ? aws_subnet.database[*].cidr_block : []
}

output "database_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 CIDR blocks assigned to the database subnets"
  value       = var.enabled ? aws_subnet.database[*].ipv6_cidr_block : []
}

output "database_subnet_group" {
  description = "ID of database subnet group"
  value       = var.enabled && length(local.database_subnet_cidrs) > 0 ? aws_db_subnet_group.database[0].id : null
}

output "database_subnet_group_name" {
  description = "Name of database subnet group"
  value       = var.enabled && length(local.database_subnet_cidrs) > 0 ? aws_db_subnet_group.database[0].name : null
}

output "cache_subnet_group" {
  description = "ID of cache subnet group"
  value       = var.enabled && length(var.enabled_caches) > 0 && length(local.database_subnet_cidrs) > 0 ? aws_elasticache_subnet_group.cache[0].name : null
}
...
output "nat_ids" {
  ...
  value       = var.enabled && local.effective_config.nat_gateway_enabled ? aws_nat_gateway.main[*].id : []
}

output "nat_public_ips" {
  description = "List of public Elastic IPs created for AWS NAT Gateway"
  value       = var.enabled && local.effective_config.nat_gateway_enabled ? aws_eip.nat[*].public_ip : []
}
...
output "public_route_table_ids" {
  ...
  value       = var.enabled && length(local.public_subnet_cidrs) > 0 && var.igw_enabled ? aws_route_table.public[*].id : []
}

output "private_route_table_ids" {
  description = "List of IDs of the private route tables"
  value       = var.enabled && length(local.private_subnet_cidrs) > 0 ? aws_route_table.private[*].id : []
}

output "database_route_table_ids" {
  description = "List of IDs of the database route tables"
  value       = var.enabled && length(local.database_subnet_cidrs) > 0 && var.create_database_route_table ? aws_route_table.database[*].id : []
}
...
output "nonroutable_subnets" {
  ...
  value       = var.enabled && local.effective_config.nonroutable_subnets_enabled ? aws_subnet.nonroutable[*].id : []
}

output "nonroutable_subnet_arns" {
  description = "List of ARNs of non-routable subnets"
  value       = var.enabled && local.effective_config.nonroutable_subnets_enabled ? aws_subnet.nonroutable[*].arn : []
}

output "nonroutable_subnets_cidr_blocks" {
  description = "List of cidr_blocks of non-routable subnets"
  value       = var.enabled && local.effective_config.nonroutable_subnets_enabled ? aws_subnet.nonroutable[*].cidr_block : []
}

output "nonroutable_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 CIDR blocks assigned to the non-routable subnets"
  value       = var.enabled && local.effective_config.nonroutable_subnets_enabled ? aws_subnet.nonroutable[*].ipv6_cidr_block : []
}

output "nonroutable_subnet_availability_zones" {
  description = "List of availability zone names for non-routable subnets"
  value       = var.enabled && local.effective_config.nonroutable_subnets_enabled ? aws_subnet.nonroutable[*].availability_zone : []
}

output "nonroutable_subnet_availability_zone_ids" {
  description = "List of availability zone IDs for non-routable subnets"
  value       = var.enabled && local.effective_config.nonroutable_subnets_enabled ? aws_subnet.nonroutable[*].availability_zone_id : []
}
...
output "vpc_flow_logs_id" {
  ...
  value       = var.enabled && local.effective_config.vpc_flow_logs_enabled ? aws_flow_log.vpc[0].id : null
}

output "vpc_flow_logs_log_group_name" {
  description = "Name of the CloudWatch Log Group for VPC Flow Logs"
  value       = var.enabled && local.effective_config.vpc_flow_logs_enabled ? aws_cloudwatch_log_group.vpc_flow_logs[0].name : null
}

output "vpc_flow_logs_log_group_arn" {
  description = "ARN of the CloudWatch Log Group for VPC Flow Logs"
  value       = var.enabled && local.effective_config.vpc_flow_logs_enabled ? aws_cloudwatch_log_group.vpc_flow_logs[0].arn : null
}

output "vpc_flow_logs_kms_key_id" {
  description = "ID of the KMS key used for VPC Flow Logs encryption"
  value       = var.enabled && local.effective_config.vpc_flow_logs_enabled ? (var.vpc_flow_logs_kms_key_id != null ? var.vpc_flow_logs_kms_key_id : aws_kms_key.flow_logs[0].key_id) : null
}

output "vpc_flow_logs_kms_key_arn" {
  description = "ARN of the KMS key used for VPC Flow Logs encryption"
  value       = var.enabled && local.effective_config.vpc_flow_logs_enabled ? (var.vpc_flow_logs_kms_key_id != null ? var.vpc_flow_logs_kms_key_id : aws_kms_key.flow_logs[0].arn) : null
}

output "vpc_flow_logs_iam_role_arn" {
  description = "ARN of the IAM role used for VPC Flow Logs"
  value       = var.enabled && local.effective_config.vpc_flow_logs_enabled ? aws_iam_role.flow_logs[0].arn : null
}
...
output "transit_gateway_attachment_id" {
  ...
  value       = var.enabled && var.transit_gateway_attachment_enabled ? aws_ec2_transit_gateway_vpc_attachment.main[0].id : null
}


output "transit_gateway_attachment_vpc_owner_id" {
  description = "VPC owner ID of the Transit Gateway VPC attachment"
  value       = var.enabled && var.transit_gateway_attachment_enabled ? aws_ec2_transit_gateway_vpc_attachment.main[0].vpc_owner_id : null
}